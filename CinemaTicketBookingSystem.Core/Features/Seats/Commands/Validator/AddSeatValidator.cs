...
namespace CinemaTicketBookingSystem.Core.Features.Seats.Commands.Validator
{
    public class AddSeatValidator : AbstractValidator<AddSeatCommand>
    {
        ...
        public AddSeatValidator(ISeatService seatService, IHallService hallService, ISeatTypeService seatTypeService)
        {
        ...
        {
            //Check if SeatNumber is  Exist in Hall
